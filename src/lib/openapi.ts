      ...
      "/api/stories/{id}": {
        ...
        delete: {
          ...
          responses: {
            ...
            "409": errorResponse("Already being worked on (ask the printer owner), or being handed to Bambuddy right now. Re-read the ticket: once intake lands it in Slicing, withdrawing no longer applies."),
            ...COMMON_ERRORS,
          },
        },
      },
